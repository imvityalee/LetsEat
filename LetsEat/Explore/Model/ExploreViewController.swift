...
class ExploreViewController: UIViewController, UICollectionViewDelegate {
    ...
    private extension ExploreViewController {
        ...
        func showRestaurantListing(segue: UIStoryboardSegue) {
               if let viewController = segue.destination as? RestaurantsListsViewController, let city = selectedCity, let index = collectionView.indexPathsForSelectedItems?.first {
     ...
     func showAlert() {
        ...
        @IBAction func unwindLocationCancle(seque: UIStoryboardSegue) {
            
        }

        @IBAction func unwindLoactionDone(segue: UIStoryboardSegue) {
            if let veiwController =  segue.source as? LocationViewController {
                selectedCity = veiwController.selectedCity
    ...
    extension ExploreViewController: UICollectionViewDataSource {
        ...
        func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
            ...
            cell.iblName.text = item.name
            cell.exploreImage.image = UIImage(named: item.image)
